...
export default [
  {
    ...
    name: 'template',
    component: Layout,
    redirect: '/template/list/base',
    meta: { title: '模板', icon: ViewModuleIcon },
    children: [
      {
        path: 'list',
        name: 'list',
      ...
      },
      {
        ...
        name: 'result',
        component: () => import('@/layouts/blank.vue'),
        redirect: '/template/result/success',
